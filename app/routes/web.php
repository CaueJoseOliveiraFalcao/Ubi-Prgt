...
Route::middleware(['auth','isAdmin'])->group(function () {
    ...
    Route::post('/create-site-register', [SiteController::class,'create_site_registe'])->name('create_site_registe');
});
Route::middleware('auth')->group(function () {
    ...
    Route::post('/site-creator', [SiteController::class, 'create'])->name('site-creator.post');
});
